package dev.kernelcraft.site.components.sections.home
...
import dev.kernelcraft.site.SubheadlineTextStyle
import dev.kernelcraft.site.components.widgets.LinkButton
import dev.kernelcraft.site.components.widgets.icons.GitHubIcon
import dev.kernelcraft.site.components.widgets.terminal.Terminal
...
// TODO: The correct way to inherit styles (both GitHub and resume inherits from hero button), what is variant? Share those styles correctly!
            ...
            Column(
                ...
                SimpleGrid(
                    ...
                    LinkButton(
                        path = "/resume",
                        text = "Resume",
                        modifier = HeroButtonStyle.toModifier().then(ResumeButtonStyle.toModifier())
                            .attr("download", "")
                    )

                    LinkButton(
                        path = ProjectInfo.GITHUB_ACCOUNT, text = "GitHub",
                        modifier = HeroButtonStyle.toModifier().then(GitHubButtonStyle.toModifier()),
