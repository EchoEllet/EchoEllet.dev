...
import dev.kernelcraft.site.components.sections.Footer
import dev.kernelcraft.site.components.sections.NavHeader
...
fun PageLayout(title: String, description: String? = null, content: @Composable ColumnScope.() -> Unit) {
    ...
    Box(
        ...
        // TODO: Remove comments in this file and adjust things
