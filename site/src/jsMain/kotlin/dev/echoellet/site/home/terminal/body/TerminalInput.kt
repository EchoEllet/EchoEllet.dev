...
import dev.echoellet.site.common.utils.browserName
import dev.echoellet.site.common.utils.selectContentsToEnd
import dev.echoellet.site.home.terminal.TerminalCursor
...
fun TerminalInput(
    ...
    Div(attrs = modifier.toAttrs()) {
        ...
        if (isTerminalInputFocused) {
            TerminalCursor(modifier = Modifier.display(DisplayStyle.InlineBlock).then(cursorModifier))
        }
    }
}
